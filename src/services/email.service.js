...
const sendWelcomeEmail = async (to, link) => {
    ...
    const welcomeHtml = `<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><style>th{height:40px}.t-center{text-align:center}.container{width:50%;margin:30px auto;background:white}@media (max-width: 600px){.container{width:95%;background:white}}hr{margin:30px 10%;color:#1d1d1d;background:#1d1d1d;height:1px}.user-details td{border:none;padding:3px}.card{box-shadow:0 4px 8px 0 rgba(0,0,0,0.2);transition:0.3s;background:white}.button{background:#a51fff;color:white;border-radius:8px;padding:12px 22px;font-size:16px;border:none}</style></head><body style="background: #eaf0f6"><div class="container" style="padding: 0"><div style="text-align: center;"> <img src="https://cdn2.hubspot.net/hub/9412756/hubfs/pianto%20(3).png?width=1200&upscale=true&name=pianto%20(3).png" style="width: 100%"></div></div><div class="container card"><div style="padding: 25px"><div class="t-center"><h2>Pianto toivottaa sinut tervetulleeksi!</h2><h3>Kiitos rekister�itymisest�!</h3><h3>P��set kirjautumaan tilillesi alla olevasta painikkeesta.</h3></div><div class="t-center"> <a href="${resetPasswordUrl}"><button class="button">Minun tilini</button></a></div><hr><div class="t-center"><h3>Kuinka tilaat ensimm�isen virityksesi</h3><h3>1. Mene alla olevan painikkeen avulla tilaus-sivulle</h3><div class="t-center"> <a href="https://tilaus.pianto.io/my-orders"><button class="button">Minun tilini</button></a></div><h3>2. Sy�t� soittimesi tiedot ja valitse haluamasi palvelut.</h3><h3>3. Varaa itsellesi sopivin ajankohta.</h3><h3>4. T�yt� yhteystietosi ja suorita maksu turvallisesti. Viritt�j� saapuu luoksesi valittuna ajankohtana.</h3></div><div class="t-center"> <img src="https://cdn2.hubspot.net/hub/9412756/hubfs/pianto.png?width=200&upscale=true&name=pianto.png" alt="" style="width: 100px"></div></div></div></body></html>`
